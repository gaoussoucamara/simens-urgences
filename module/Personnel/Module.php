...
use Personnel\Model\Patient;
use Personnel\Model\PatientTable;
...
// 				),
	...
	public function getServiceConfig()
	{
		return array (
				'factories' => array (
						'Personnel\Model\PatientTable' => function ($sm) {
							$tableGateway = $sm->get ( 'PatientPersonnelTable1Gateway' );
							$table = new PatientTable ( $tableGateway );
							return $table;
						},
						'PatientPersonnelTable1Gateway' => function ($sm) {
