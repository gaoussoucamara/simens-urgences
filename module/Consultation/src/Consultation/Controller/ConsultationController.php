...
class ConsultationController extends AbstractActionController {
	...
	public function getInfosModificationAdmissionAction() {
		...
		//R�cup�ration du rpu_hospitalisation
		//R�cup�ration du rpu_hospitalisation
		...
		//R�cup�ration du rpu_traumatisme
		//R�cup�ration du rpu_traumatisme
	...
	public function getHistoriquesTerrainParticulierAction() {
		...
		//Enregistrement et mise � jour des donn�es sur l'admission et la consultation
		//Enregistrement et mise � jour des donn�es sur l'admission et la consultation
	...
	public function impressionRpuHospitalisationAction(){
		...
		$donnees['resume_syndromique'] = str_replace("’", "'", $this->params ()->fromPost (  'resume_syndromique' ));
		$donnees['resume_syndromique'] = str_replace("�", "oe" ,$donnees['resume_syndromique']); 
		
		$donnees['hypotheses_diagnostiques'] = str_replace("’", "'", $this->params()->fromPost('hypotheses_diagnostiques'));
		$donnees['hypotheses_diagnostiques'] = str_replace("�", "oe" ,$donnees['hypotheses_diagnostiques']); 
		
		$donnees['examens_complementaires'] = str_replace("’", "'", $this->params()->fromPost('examens_complementaires'));
		$donnees['examens_complementaires'] = str_replace("�", "oe" ,$donnees['examens_complementaires']); 
		
		$donnees['traitement'] = str_replace("’", "'", $this->params()->fromPost('traitement'));
		$donnees['traitement'] = str_replace("�", "oe" ,$donnees['traitement']);
		
		$donnees['resultats_examens_complementaires'] = str_replace("’", "'", $this->params()->fromPost('resultats_examens_complementaires'));
		$donnees['resultats_examens_complementaires'] = str_replace("�", "oe" ,$donnees['resultats_examens_complementaires']);
		
		$donnees['mutation'] = str_replace("’", "'", $this->params()->fromPost('mutation'));
		$donnees['mutation'] = str_replace("�", "oe" ,$donnees['mutation']);
		
		$donnees['mise_a_jour_1'] = str_replace("’", "'", $this->params()->fromPost('mise_a_jour_1'));
		$donnees['mise_a_jour_1'] = str_replace("�", "oe" ,$donnees['mise_a_jour_1']);
		
		$donnees['mise_a_jour_2'] = str_replace("’", "'", $this->params()->fromPost('mise_a_jour_2'));
		$donnees['mise_a_jour_2'] = str_replace("�", "oe" ,$donnees['mise_a_jour_2']);
		
		$donnees['mise_a_jour_3'] = str_replace("’", "'", $this->params()->fromPost('mise_a_jour_3'));
		$donnees['mise_a_jour_3'] = str_replace("�", "oe" ,$donnees['mise_a_jour_3']);
		
		$donnees['avis_specialiste'] = str_replace("’", "'", $this->params()->fromPost('avis_specialiste'));
		...
		//Envoi des donn�es des infirmiers
	...
	public function impressionRpuTraumatologieAction(){
		...
		$donnees['cote_dominant'] = str_replace("’", "'", $this->params ()->fromPost (  'cote_dominant' ));
		$donnees['cote_dominant'] = str_replace("�", "oe" ,$donnees['cote_dominant']);
		
		$donnees['date_heure'] = str_replace("’", "'", $this->params ()->fromPost (  'date_heure' ));
		$donnees['date_heure'] = str_replace("�", "oe" ,$donnees['date_heure']);
		
		$donnees['circonstances'] = str_replace("’", "'", $this->params ()->fromPost (  'circonstances' ));
		$donnees['circonstances'] = str_replace("�", "oe" ,$donnees['circonstances']);
		
		$donnees['antecedent'] = str_replace("’", "'", $this->params ()->fromPost (  'antecedent' ));
		$donnees['antecedent'] = str_replace("�", "oe" ,$donnees['antecedent']);
		
		$donnees['examen_physique'] = str_replace("’", "'", $this->params ()->fromPost (  'examen_physique' ));
		$donnees['examen_physique'] = str_replace("�", "oe" ,$donnees['examen_physique']);
		
		$donnees['examen_paraclinique'] = str_replace("’", "'", $this->params ()->fromPost (  'examen_paraclinique' ));
		$donnees['examen_paraclinique'] = str_replace("�", "oe" ,$donnees['examen_paraclinique']);
		
		$donnees['resultat_examen_complementaire'] = str_replace("’", "'", $this->params ()->fromPost (  'resultat_examen_complementaire' ));
		$donnees['resultat_examen_complementaire'] = str_replace("�", "oe" ,$donnees['resultat_examen_complementaire']);
		
		$donnees['mecanismes'] = str_replace("’", "'", $this->params ()->fromPost (  'mecanismes' ));
		$donnees['mecanismes'] = str_replace("�", "oe" ,$donnees['mecanismes']);
		
		$donnees['mecanismes_precision'] = str_replace("’", "'", $this->params ()->fromPost (  'mecanismes_precision' ));
		...
		$donnees['indication_precision'] = str_replace("’", "'", $this->params ()->fromPost (  'indication_precision' ));
		$donnees['indication_precision'] = str_replace("�", "oe" ,$donnees['indication_precision']);
		
		$donnees['diagnostic'] = str_replace("’", "'", $this->params ()->fromPost (  'diagnostic' ));
		$donnees['diagnostic'] = str_replace("�", "oe" ,$donnees['diagnostic']);
		
		$donnees['diagnostic_precision'] = str_replace("’", "'", $this->params ()->fromPost (  'diagnostic_precision' ));
		$donnees['diagnostic_precision'] = str_replace("�", "oe" ,$donnees['diagnostic_precision']);
		
		$donnees['conduite'] = str_replace("’", "'", $this->params ()->fromPost (  'conduite' ));
		$donnees['conduite'] = str_replace("�", "oe" ,$donnees['conduite']);
		
		$donnees['motif_sortie'] = str_replace("’", "'", $this->params ()->fromPost (  'motif_sortie' ));
		$donnees['motif_sortie'] = str_replace("�", "oe" ,$donnees['motif_sortie']);
		
		$donnees['rendez_vous'] = str_replace("’", "'", $this->params ()->fromPost (  'rendez_vous' ));
		$donnees['rendez_vous'] = str_replace("�", "oe" ,$donnees['rendez_vous']);
		
		$donnees['specialiste_trauma'] = str_replace("’", "'", $this->params ()->fromPost (  'specialiste_trauma' ));
		$donnees['specialiste_trauma'] = str_replace("�", "oe" ,$donnees['specialiste_trauma']);
		
		$donnees['conduite_specialiste'] = str_replace("’", "'", $this->params ()->fromPost (  'conduite_specialiste' ));
	...
	public function impressionRpuSortieAction(){
		...
		$donnees['diganostic'] = str_replace("’", "'", $this->params ()->fromPost (  'diganostic' ));
		$donnees['diganostic'] = str_replace("�", "oe" ,$donnees['diganostic']);
		
		$donnees['diganostic_associe'] = str_replace("’", "'", $this->params ()->fromPost (  'diganostic_associe' ));
		$donnees['diganostic_associe'] = str_replace("�", "oe" ,$donnees['diganostic_associe']);
		
		$donnees['traitement'] = str_replace("’", "'", $this->params ()->fromPost (  'traitement' ));
		$donnees['traitement'] = str_replace("�", "oe" ,$donnees['traitement']);
		
		$donnees['examens_complementaires_demandes'] = str_replace("’", "'", $this->params ()->fromPost (  'examens_complementaires_demandes' ));
		$donnees['examens_complementaires_demandes'] = str_replace("�", "oe" ,$donnees['examens_complementaires_demandes']);
		
		$donnees['mode_sortie'] = str_replace("’", "'", $this->params ()->fromPost (  'mode_sortie' ));
		$donnees['mode_sortie'] = str_replace("�", "oe" ,$donnees['mode_sortie']);
		
		$donnees['liste_mutation'] = str_replace("’", "'", $this->params ()->fromPost (  'liste_mutation' ));
		$donnees['liste_mutation'] = str_replace("�", "oe" ,$donnees['liste_mutation']);
		
		$donnees['transfert'] = str_replace("’", "'", $this->params ()->fromPost (  'transfert' ));
		$donnees['transfert'] = str_replace("�", "oe" ,$donnees['transfert']);
		
		$donnees['evacuation'] = str_replace("’", "'", $this->params ()->fromPost (  'evacuation' ));
	...
	public function imprimerRpuHospitalisationAction()
	{
		...
		$tabInformations[5]['titre'] = 'R�sultats des examens compl�mentaires';
		...
		$tabInfosActesExamens[1]['titre'] = 'Les examens compl�mentaires';
	...
	public function imprimerRpuTraumatologieAction()
	{
		...
		$tabInformations[0]['titre'] = 'C�t� dominant';
		...
		$tabInformations[3]['titre'] = 'Ant�c�dent';
		$tabInformations[3]['type' ] = 1;
		...
		$tabInformations[6]['titre'] = 'R�sultat des examens compl�mentaires';
		...
		$tabInformations[7]['titre'] = 'M�canismes';
		$tabInformations[7]['type' ] = 2;
		...
		$tabInformations[8]['titre'] = 'M�canismes pr�cision';
		$tabInformations[8]['type' ] = 2;
		...
		$tabInformations[10]['titre'] = 'Indication pr�cision';
	...
	public function imprimerRpuSortieAction(){
		...
		$tabInformations[1]['titre'] = 'Diagnostic associ�';
		$tabInformations[1]['type' ] = 1;
		...
		$tabInformations[3]['titre'] = 'Examens compl�mentaires demand�s';
		$tabInformations[3]['type' ] = 1;
		...
		$tabInformations[6]['titre'] = 'Transf�rer vers';
		$tabInformations[6]['type' ] = 2;
