...
class RpuHospitalisationPdf3
{
	...
	protected  function getNoteTC(){
		...
		$maxLigne = 31;
 		...
 		//************* Gestion des hypotheses diagnostiques ************
 		if($tableauTemoinLimite[2][1] == 1){
 				
 			$debut = $tableauTemoinLimite[2][2];
 			$fin = $tableauTemoinLimite[2][3];
 		...
 		//************* Gestion des examens complémentaires ************
 		if($tableauTemoinLimite[3][1] == 1){
 				
 			$debut = $tableauTemoinLimite[3][2];
 			$fin = $tableauTemoinLimite[3][3];
 		...
 		//************* Gestion des traitements ************
 		if($tableauTemoinLimite[4][1] == 1){
 		
 			$debut = $tableauTemoinLimite[4][2];
 			$fin = $tableauTemoinLimite[4][3];
 		...
 		//************* Gestion des résultats des examens complémentaires ************
 		if($tableauTemoinLimite[5][1] == 1){
 			$debut = $tableauTemoinLimite[5][2];
 			$fin = $tableauTemoinLimite[5][3];
 			...
 			if($debut < $fin){
 				...
 				for($i = $debut ; $i < $fin ; $i++){
 					if($nbLigne < $maxLigne){
 						...
 						$this->_page->setFont($this->_policeContenu, 11.3);
		...
		//************* Gestion des mise à jours 3 ************
 		...
 		if($tableauTemoinLimite[10][1] == 1){
 			if($tab_avis_specialiste){
 				$debut = $tableauTemoinLimite[10][2];
 				$fin   = $tableauTemoinLimite[10][3];
...
//  		$this->setSuitePageRpu($suitePageRpu);
    ...
    public function getPiedPage(){
		...
		$imageHeader = ZendPdf\Image::imageWithPath($tabURI[0].'public/images_icons/number-three_r.png');
