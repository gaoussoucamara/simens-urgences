...
;(function($){
	...
	// This actually adds the .contextMenu2() function to the jQuery namespace
	$.fn.contextMenu2 = function(menu,options) {
		var cmenu = $.contextMenu2.create(menu,options);
