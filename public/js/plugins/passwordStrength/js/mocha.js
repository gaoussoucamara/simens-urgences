...
$(document).ready(function() 
{
	...
	outputResult();
	$("#nouveaupassword").bind("keyup", checkVal);
...
function init()
{
	strPassword= $("#nouveaupassword").val();
...
function outputResult()
{
	...
	else if (charPassword.length < minPasswordLength)
	{
		...
		complexity.html("Trop court !").removeClass("strong stronger strongest").addClass("weak");
	}
	else if (score<50)
	{
		complexity.html("Faible !").removeClass("strong stronger strongest").addClass("weak");
	}
	else if (score>=50 && score<75)
	{
		complexity.html("Moyen !").removeClass("stronger strongest").addClass("strong");
	}
	else if (score>=75 && score<100)
	{
		complexity.html("Fort !").removeClass("strongest").addClass("stronger");
	}
	else if (score>=100)
	{
		complexity.html("Bien s&eacute;curis&eacute;!").addClass("strongest");
	}
