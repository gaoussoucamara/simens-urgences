...
function affichervue(id){
    ...
    var chemin = '/simens/public/pharmacie/vue-medicament';
    $.ajax({
        type: 'POST',
        url: chemin ,
        data: $(this).serialize(),  
        ...
        success: function(data) {
        	     ...
        	     $("#titre").replaceWith("<div id='titre' style='font-family: police2;  color: green; font-size: 20px; font-weight: bold;'><iS style='font-size: 25px;'>&curren;</iS> D&Eacute;TAILS SUR LE M&Eacute;DICAMENT</div>");
...
function modifiermedicament(id){
	  ...
	  var chemin = '/simens/public/pharmacie/modification';
	    $.ajax({
	        type: 'GET',
	        url: chemin ,  
	        data:'id='+id,
	        success: function(data) {
	        	     ...
	        	     $("#titre").replaceWith("<div id='titre' style='font-family: police2;  color: green; font-size: 20px; font-weight: bold;'><iS style='font-size: 25px;'>&curren;</iS> MODIFIER LES D&Eacute;TAILS SUR LE M&Eacute;DICAMENT</div>");
	        	     var result = jQuery.parseJSON(data);
		...
		$indication_therapeutique = $("#indication_therapeutique").val();
		     ...
		     $voie_administration = $("#voie_administration").val();
		             ...
		             $.ajax({
		 	    	    ...
		 	    	    success: function(data) {    	 	    	    	
		 	    	    	var result = jQuery.parseJSON(data);
		 	    	    	vart ='/simens/public/pharmacie/Pharmacie/liste-medicaments';
