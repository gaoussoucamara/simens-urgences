    	...
    	$.ajax({
    		...
    		success : function(data) {
    			...
    			$(".chargementPageModification").fadeOut(function(){
    				...
    				//Blocage des champs et d�blocage des champs pour le sp�cialiste
    				setTimeout(function(){
    ...
    function historiquesDesConsultations(id_patient,id_admission){
    	...
    	oTableHistoriqueConsultationPatient = $('#ListeConsultationPatient').dataTable( {
    				...
    				"sAjaxSource":  tabUrl[0] + "public/consultation/historiques-des-consultations-patient-dans-liste-historique-ajax/"+id_patient,
    				"fnDrawCallback": function() 
    				{
    					//markLine();
    					//clickRowHandler();
