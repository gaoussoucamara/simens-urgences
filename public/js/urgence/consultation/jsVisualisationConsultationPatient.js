	...
	function raffarichirLaListePatientAdmisParInfirmierService(){
	  ...
	  function dep1(){
	  	$('#depliantBandelette').click(function(){
	  		$("#depliantBandelette").replaceWith("<img id='depliantBandelette' style='cursor: pointer; position: absolute; padding-right: 120px; margin-left: -5px;' src='"+tabUrl[0] + "public/img/light/plus.png' />");
	  		dep();
	  	    $('#BUcheckbox').animate({
	  	        height : 'toggle'
	  	    },1000);
	  ...
	  function dep(){
	  	$('#depliantBandelette').click(function(){
	  		$("#depliantBandelette").replaceWith("<img id='depliantBandelette' style='cursor: pointer; position: absolute; padding-right: 120px; margin-left: -5px;' src='"+tabUrl[0] + "public/img/light/minus.png' />");
	  		dep1();
	  	    $('#BUcheckbox').animate({
	  	        height : 'toggle'
	  	    },1000);
