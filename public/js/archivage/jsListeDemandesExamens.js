    ...
    function listeExamensBio(id_personne, idDemande){ 
    	var id_cons = $("#"+idDemande).val();
    	var chemin = tabUrl[0]+'public/archivage/liste-examens-demander';
        $.ajax({
            type: 'POST',
            url: chemin ,
            data:{'id_personne':id_personne, 'id_cons':id_cons, 'encours':111, 'examensBio': 1},
    	...
    	$( "#application_examen" ).dialog({
    		...
    		buttons: {
    			"Terminer": function() {
    				...
    				var chemin = tabUrl[0]+'public/archivage/appliquer-examen';
    		    	$.ajax({
    		    		type: 'POST',
    		    		url: chemin ,
    		    		data:({'idDemande':idDemande, 'techniqueUtiliser':technique_utilise, 'noteResultat':resultat, 'conclusion':conclusion, 'update':0}),
    		    		success: function() {    
    		    			...
    		    			var chemin = tabUrl[0]+'public/archivage/raffraichir-liste-examens-bio';
    	    		    	$.ajax({
    	    		    		type: 'POST',
    	    		    		url: chemin ,
    	    		    		data:({'id_cons':id_cons}),
    	...
    	$( "#envoyer_examen" ).dialog({
    		...
    		buttons: {
    			"Terminer": function() {
    				...
    				var id_cons = $('#Examen_id_cons').val();
    				var chemin = tabUrl[0]+'public/archivage/envoyer-examen-bio';
    		    	$.ajax({
    		    		type: 'POST',
    		    		url: chemin ,
    		    		data:({'idDemande':idDemande, 'id_cons':id_cons}),
    ...
    function modifierExamenBio(idDemande) {
    	...
    	var chemin = tabUrl[0]+'public/archivage/modifier-examen';
    	$.ajax({
    		type: 'POST',
    		url: chemin ,
    		data:({'idDemande':idDemande}),
    ...
    function vueExamenBio(idDemande){ 
    	var chemin = tabUrl[0]+'public/archivage/verifier-si-resultat-existe';
    	$.ajax({
    		type: 'POST',
    		url: chemin ,
    		data:({'idDemande':idDemande}),
    		success: function(data) {    
    			...
    			vueExamenAAppliquer(hauteur, largeur);
    	    	var chemin = tabUrl[0]+'public/archivage/vue-examen-appliquer';
