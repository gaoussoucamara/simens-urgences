...
$("#AfficherLecteurInstrumental").hover(function(){ $('#temoinAudio').val(2); });
                    ...
                    function AppelLecteurMp3(){
                      var chemin = tabUrl[0]+'public/archivage/afficher-mp3';
                    ...
                    function scriptAjoutMp3(){
                    	$(function () { 
                    	    $('#my_form').change(function (e) {
                   	        ...
                   	        var chemin = tabUrl[0]+'public/archivage/ajouter-mp3';
                   	        $.ajax({
                   	        	url: chemin ,
                   	            ...
                   	            success: function (response) { 
                   	            	...
                   	            	$.ajax({
                           	        	url: tabUrl[0]+'public/archivage/inserer-bd-mp3',
                           	            type: $form.attr('method'),
                   	...
                   	function supprimerAudioMp3(id){ 
                   		var chemin = tabUrl[0]+'public/archivage/supprimer-mp3';
                   		var id_cons = $('#id_cons').val(); 
                   		var type = $('#temoinAudio').val();
                   	    $.ajax({
                   	    	url: chemin ,
