    ...
    function listeExamensMorpho(id_personne, idDemande){ 
    	...
    	var chemin = tabUrl[0]+'public/archivage/liste-examens-demander-morpho';
        $.ajax({
            type: 'POST',
            url: chemin ,
    ...
    function vueExamenMorpho(idDemande){
    	...
    	$.ajax({
    		...
    		success: function(data) {    
    			...
    			vueExamenAAppliquer(hauteur, largeur);
    	    	var chemin = tabUrl[0]+'public/archivage/vue-examen-appliquer-morpho';
    	    	$.ajax({
    	    		type: 'POST',
    	    		url: chemin ,
    	    		data:({'idDemande':idDemande}),
    ...
    function listepatient(){
    	...
    	$("#terminer").click(function(){
		  ...
		  var id = $('#temoinListeConcerneePourVisualisation').val();
		  if(id == 2){
			  vart=tabUrl[0]+'public/archivage/liste-resultats-radiologie';
			  $(location).attr("href",vart);
		  } else {
			  vart=tabUrl[0]+'public/archivage/liste-demandes-examens-morpho';
			  $(location).attr("href",vart);
		  }
