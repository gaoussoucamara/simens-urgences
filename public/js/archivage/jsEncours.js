    ...
    function listepatient(){
	    ...
	    $("#terminerdetailhospi").click(function(){
	    	$("#titre").html("<iS style='font-size: 25px;'>&curren;</iS> LISTE DES PATIENTS");
	    	$("#vue_detail_hospi_patient").fadeOut(function(){$("#contenu").fadeIn(100); $("#vue_detail_hospi_patient").html("");});
            	...
            	$( "#confirmationSup" ).dialog({
            	    ...
            	    buttons: {
            	        "Oui": function() {
            	        	 ...
            	        	 var chemin = tabUrl[0]+'public/archivage/supprimer-soin';
            	                $.ajax({
            	                    type: 'POST',
            	                    url: chemin ,
            	                    data:({'id_sh':id_sh}),
            ...
            /************************************************************************************************************************/
                ...
                function modifiersoin(id_sh , id_hosp){ 
                	modifiersoinPopup(id_sh,id_hosp);
                	 var chemin = tabUrl[0]+'public/archivage/modifier-soin';
 	                $.ajax({
 	                    type: 'POST',
 	                    url: chemin ,
 	                    data:({'id_sh':id_sh, 'id_hosp':id_hosp}),
                ...
                function controleSaisiPopup(id_sh,id_hosp) {
                	...
                	if(!$('#medicament_m').val()){
        	        	 ...
        	        	 */
        	        	 ...
        	        	 var chemin = tabUrl[0]+'public/archivage/en-cours';
     	                 $.ajax({
     	                    type: 'POST',
     	                    url: chemin ,
     	                    data:({
    ...
    var theHREF = tabUrl[0]+"public/archivage/services";
	  ...
	  function ListeSoinsVisualisationHospi(){
		  ...
		  $.ajax({
			  type: 'POST',
			  url: tabUrl[0]+"public/archivage/liste-soins-visualisation-hosp",
	  ...
	  function envoiDesDonnees(){
		  ...
		  $("#terminerExamenDuJour").click(function(){ 
			  ...
			  if(valid == true ) { 
				  ...
				  $.ajax({
					  type: 'POST',
					  url: tabUrl[0]+"public/archivage/enregistrer-examen-du-jour",
	  ...
	  function AppelListeExamensDuJoursHospi(id_hosp){
		  $.ajax({
			  type: 'POST',
			  url: tabUrl[0]+"public/archivage/liste-examen-du-jour",
			  data: {'id_hosp':id_hosp },
			  success: function(data) {
				  var result = jQuery.parseJSON(data);
	  ...
	  function visualiserExamenDuJour(id_examen_jour){
		  ...
		  formulaire.setAttribute("action","/simens/public/archivage/vue-examen-jour"); 
      	...
      	$( "#confirmationSuppExamenJour" ).dialog({
      	    ...
      	    buttons: {
      	        "Oui": function() {
      	        	 ...
      	        	 var chemin = tabUrl[0]+'public/archivage/supprimer-examen-jour';
      	                $.ajax({
      	                    type: 'POST',
      	                    url: chemin ,
