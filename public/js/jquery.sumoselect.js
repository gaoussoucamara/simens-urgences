...
(function ($) {
    ...
    $.fn.SumoSelect = function (options) {
        ...
        var settings = $.extend({
            placeholder: 'Choisir les heures',   // Dont change it here.
            csvDispCount: 3,              // display no. of items in multiselect. 0 to display all.
            captionFormat:'{0} Séléctionnés', // format of caption text. you can set your locale.
        ...
        var ret = this.each(function () {
            ...
            this.sumo = {
                ...
                createElems: function () {
                    ...
                    O.select = O.E.parent();
                    O.caption = $('<span></span>');
                    O.CaptionCont = $('<p class="CaptionCont"><i></i></p>').addClass('SlectBox').attr('style', O.E.attr('style')).prepend(O.caption);
                ...
                createLi: function (opt,i) { 
                    ...
                    $(function(){ 
                    var i = 1;
                    $(".SumoSelect > .optWrapper > .options > #heure"+j).click(function(){
              	  	    if(i==1){
              	  	  	   $("#img"+j+" i").html('<img style="margin-left: 5px;" src="../images_icons/tickn_16.png" />'); i=0;
              	  	    } else { 
                	  	  	   $("#img"+j+" i").html(''); i=1;
              	  	  	   }
              	    });
