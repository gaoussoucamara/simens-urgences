...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		monthNames: ["Janvier","Fevrier","Mars","Avril","Mai","Juin",
			"Juiller","Aout","Septembre","Octobre","Novembre","Decembre"], // Names of months for drop-down and formatting
		monthNamesShort: ["Jan", "Fev", "Mar", "Avr", "Mai", "Jun", "Jul", "Aut", "Sep", "Oct", "Nov", "Dec"], // For formatting
